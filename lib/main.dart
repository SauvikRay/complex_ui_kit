...
final _controller=Get.put(DynamicController());
@override
  void initState() {
                                    ...
                                    ()=> ListView.separated(
                                            ...
                                            itemBuilder: (context,index){
                                              ...
                                              return Animate(
                                                ...
                                                child: ChoiceChip(
                                                  avatar: isSelected?const Icon(CupertinoIcons.clear,size: 15,color: Colors.white,):null,
                                                  ...
                                                  shape: RoundedRectangleBorder(borderRadius:const BorderRadius.all(Radius.circular(5)),side: BorderSide(color:isSelected?CupertinoColors.activeBlue :CupertinoColors.inactiveGray)),
                                                  ...
                                                  onSelected: (value) {
                                                    // log('Selected Chips value $value');
                                                      if(value){
                                                        ...
                                                        isVisible.value=value;
                                                        _controller.selectedChips.remove(element.subCateId);
                                                        _controller.subcategory.remove(element);
                                                      
                                                        // log('allSubcategory length: ${allSubcategory.length}');
                                                        Set<SubCategory> uniqueItem= Set<SubCategory>.from(_controller.allSubcategory).union(Set<SubCategory>.from(_controller.subcategory));
                                                        // log('Item length: ${uniqueItem.length}');
                                                   
                                                        _controller.subcategory.addAll(uniqueItem.toList());
                                                                    
                                                        _controller.childCategory.clear();
                                                           if(_controller.selectedChildChips.isNotEmpty){

                                                        _controller.selectedChildChips.clear();
                                                      }

                                                            log('Selected Child :${_controller.selectedChildChips.length}')            ;
                                                        // setState(() {});
                                                      }
                                                      // _controller.allChildCategoryItem.removeWhere((element) => element.id==_controller.childCategory.);
                                                      _controller.allChildCategoryItem.assignAll(_controller.childCategory);
