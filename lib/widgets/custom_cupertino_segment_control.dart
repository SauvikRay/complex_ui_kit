...
///
/// {@tool dartpad}
/// This example shows a [CustomCupertinoSegmentedControl] with an enum type.
///
...
/// See also:
///
///  * [CustomCupertinoSegmentedControl], a segmented control widget in the style used
///    up until iOS 13.
///  * <https://developer.apple.com/design/human-interface-guidelines/ios/controls/segmented-controls/>
class CustomCupertinoSegmentedControl<T extends Object> extends StatefulWidget {
  ...
  /// The CustomCupertinoSegmentedControl will be placed inside this padding.
  ///
  /// Defaults to EdgeInsets.symmetric(horizontal: 16.0)
  final EdgeInsetsGeometry? padding;

  @override
  State<CustomCupertinoSegmentedControl<T>> createState() => _SegmentedControlState<T>();
}

class _SegmentedControlState<T extends Object> extends State<CustomCupertinoSegmentedControl<T>> with TickerProviderStateMixin<CustomCupertinoSegmentedControl<T>> {
  T? _pressedKey;
  ...
  @override
  void didUpdateWidget(CustomCupertinoSegmentedControl<T> oldWidget) {
